...
def run_analysis(input_files_list):
    ...
    #         print(art)
            ...
            for sent in articles[art]["sentences"]:
                ...
                # analyse entitities
                if len(sent["entities"])!=0 and "Mutation" in sent["entities"].keys():
...
def run(analysis_config):
    ...
    if df.empty:
        ...
        plt.savefig(path_+"{}_top_{}_entities.png".format( entity,n), bbox_inches="tight", format="png")
        plt.savefig(path_+"{}_top_{}_entities.eps".format( entity,n), bbox_inches="tight", format="eps")
        ...
        # print id graph
            ...
            path_ = analysis_config["output_path"] + "/analysis_{}/".format(entity)
            os.makedirs(path_, exist_ok=True)
            plt.savefig(path_+"{}_top_{}_ids.png".format( entity,n), bbox_inches="tight", format="png")
